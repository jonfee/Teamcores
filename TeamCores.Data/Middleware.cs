...
namespace TeamCores.Data
{
    ...
    {
        public static IApplicationBuilder UseDataMiddleware(this IApplicationBuilder builder, MiddlewareOptions options)
        {
            if (builder == null)
            {
        ...
        public static IApplicationBuilder UseDataMiddleware(this IApplicationBuilder builder, IConfigurationRoot config)
        {
            return UseDataMiddleware(builder, new MiddlewareOptions { Configuration = config });
        }
    }
